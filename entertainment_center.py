""" interfaces for creating list of movies and genrate
    Html Page to display the list of movies ."""
...
MARVEL = media.Movie("CAPTAIN MARVEL",
                     "Captain Marvel is a 2019 superhero film based on the Marvel Comics superheroine Carol Danvers/Captain Marvel",  # NOQA
                     "https://www.youtube.com/watch?"
                     "v=lokJkv32EUA",
                     "https://ia.media-imdb.com/images/M/MV5BMTQ3MjIyMDQxOF5BMl5BanBnXkFtZTgwNDIxNTM2OTE@._V1_.jpg")  # NOQA

# create FRIENDS Movie Object
FRIENDS = media.Movie("FRIENDS",
                      "Friends The Movie is both, a continuation and finale to the hit TV series Friends.",  # NOQA
...
Avengers = media.Movie("Avengers: Infinity War",
                       "The Avengers will have to team up with the Guardians of the Galaxy to have any hope of taking down Thanos and his Black Order.",  # NOQA
...
VENOM = media.Movie("VENOM",
                    ...
                    "https://ia.media-imdb.com/images/M/MV5BMTU3MTQyNjQwM15BMl5BanBnXkFtZTgwNDgxNDczNTM@._V1_SY1000_CR0,0,675,1000_AL_.jpg")  # NOQA
...
Skyscraper = media.Movie("Skyscraper",
                         ...
                         "https://ia.media-imdb.com/images/M/MV5BOGM3MzQwYzItNDA1Ny00MzIyLTg5Y2QtYTAwMzNmMDU2ZDgxXkEyXkFqcGdeQXVyMjMxOTE0ODA@._V1_SY1000_SX632_AL_.jpg")  # NOQA
